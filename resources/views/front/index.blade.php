                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                ...
                                <a class="text-secondary font-weight-medium text-decoration-none" href="{{route('front.single')}}">View All</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{asset('post_images/'.$post->Feature_image)}}" style="object-fit: cover;">
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="{{$post->link}}">{{$post->title}}</a>
                                ...
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="ml-3"><i class="far fa-comment mr-2"></i>{{$post->shares}}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiYXIifQ%3D%3D%22%7D" class="d-block w-100 text-white text-decoration-none mb-3" style="background: #52AAF4;">
                                <i class="fab fa-twitter text-center py-4 mr-3" style="width: 65px; background: rgba(0, 0, 0, .2);"></i>
                                <span class="font-weight-medium">12,345 Followers</span>
                            </a>
                            <a href="https://ae.linkedin.com/" class="d-block w-100 text-white text-decoration-none mb-3" style="background: #0185AE;">
